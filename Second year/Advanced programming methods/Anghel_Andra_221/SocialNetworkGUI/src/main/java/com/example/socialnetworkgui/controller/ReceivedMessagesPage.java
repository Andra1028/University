...
public class ReceivedMessagesPage {
    ...
    public void initialize() {
        firstnameColumn.setCellValueFactory(new PropertyValueFactory<Message, String>("user1Firstname"));
        lastnameColumn.setCellValueFactory(new PropertyValueFactory<Message, String>("user1Lastname"));
        messageColumn.setCellValueFactory(new PropertyValueFactory<Message, String>("message"));
       messTable.setItems(model);
    }

    private void initModel() {
        Iterable<Message> allUsers = srvu.receivedMessages();
        if(allUsers != null) {
