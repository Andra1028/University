...
public class SentFriendRequestPage implements Observer<FriendshipEntityChangeEvent> {


    @FXML
    TableView<User> sentTable;
    @FXML
    ...
    public void initialize() {
        ...
        sentTable.setItems(model);
    }

    private void initModel() {
        Iterable<User> allUsers = srvu.getSentFriendRequests();
        if(allUsers != null) {
...
//            messageLabel.setText(srvu.findOne(14L).toString());
            ...
            User selected= sentTable.getSelectionModel().getSelectedItem();
